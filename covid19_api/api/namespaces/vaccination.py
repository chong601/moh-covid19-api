...
vax_malaysia = api.model('vax_malaysia', {
    ...
    'daily_full': fields.Integer(title='2nd doses (for double-dose vaccines) and 1-dose vaccines (e.g. Cansino) delivered between 0000 and 2359 on date.'),
    'daily': fields.Integer(title='Total daily delivered between 0000 and 2359 on date'),
    'daily_partial_child': fields.Integer(title='1st doses (for double-dose vaccines) delivered for children between 0000 and 2359 on date'),
    'daily_full_child': fields.Integer(title='2nd doses (for double-dose vaccines) and 1-dose vaccines (e.g. Cansino) delivered for children between 0000 and 2359 on date.'),
    ...
    'cumul_partial_child': fields.Integer(title='Sum of cumulative 1st doses (for double-dose vaccines) delivered for children between 0000 and 2359 on date'),
    'cumul_full_child': fields.Integer(title='Sum of cumulative 2nd doses (for double-dose vaccines) and 1-dose vaccines (e.g. Cansino) delivered for children between 0000 and 2359 on date.'),
